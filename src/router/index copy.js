...
export const asyncRoutes = [
    ...
    children: [
      {
        ...
        component: () => import('@/views/admin/overview'),
        name: 'overview',
        meta: { title: '全局视图', icon: 'component', noCache: true }
      }
    ]
  },
  {
    path: '/software',
    component: () => import('@/views/admin/software'),
    name: 'software',
    meta: {
      title: '成果仓库',
      icon: 'tree-table',
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'demand',
        component: () => import('@/views/admin/demand/software-demand'),
        meta: { title: '需求管理' }
      }
    ]
  },
    ...
    children: [
      {
        ...
        name: 'wiki',
        meta: { title: '知识库', icon: 'education', noCache: true }
      }
    ]
  },
  {
