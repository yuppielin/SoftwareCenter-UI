<template>
  <div id="theme">
    <router-link :to="'/index/theme/'+data.id">
      <img width="100%" height="150" :src="data.picPath != null ? logoAndPicUrl+data.picPath : defaultS" :onerror="defaultS">
...
<style lang="scss">
    ...
    #theme:hover .theme-title{
        ...
        font-size: 22px;
        font-weight: bold;
        border: 3px solid #1b8fd8;
        padding-top:45px;
    }
    #theme:hover .theme-btn{
        display: block;
    }
</style>
