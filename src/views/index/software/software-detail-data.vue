    ...
    <div slot="header" class="padding">
      <el-row>
        ...
        <el-col :span="12" style="text-align:right;">
          <el-button type="primary" size="mini" onclick="history.go(-1)" icon="el-icon-back">返回</el-button>
        </el-col>
      </el-row>
    </div>
     <el-dialog
    ...
    <el-table :data="getList" size="mini">
      ...
      <el-table-column align="center" header-align="center" label="操作" width="200">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="primary" v-if="permission==1" @click="downloadSoftwareData(scope.row)">下载</el-button>
        </template>
      </el-table-column>
    </el-table>
