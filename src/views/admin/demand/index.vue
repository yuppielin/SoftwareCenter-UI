...
<div class="app-container">
    <div class="cur-top-admin">
        ...
        <span class="title" >软件运营反馈管理</span>
    </div>
  <el-card>
    <!--需求导入对话框--->
    <el-dialog v-el-drag-dialog :visible.sync="dialogVisible" title="运营反馈导入" width="30%" @dragDialog="handleDrag">
      <el-row :gutter="10">
        <el-col :span="12">
        ...
        <el-col :span="12" style="text-align:right;">
          <el-button type="text" style="color:blue;margin-right:10px;" @click="downloadDemandTemplate">反馈模板下载</el-button>
        </el-col>
      </el-row>
      <el-upload
    ...
    <el-tabs v-model="activeName" @tab-click="getDemandQuery">
      <el-tab-pane name="first" label="新增反馈">
        <div style="margin-bottom:10px;">
          <el-row :gutter="10">
            <el-col :span="10" style="text-align:left">
              ...
              <el-button :loading="loadingExport" size="small" type="primary" icon="el-icon-download" style="background: #1e7d34;border:0;height:32px" @click="exportDemand">运营反馈导出</el-button>
            </el-col>
        ...
        <el-table :data="demandData" size="mini" stripe :header-cell-style="{background:'#2BB56E',height:'30px'}" style="height:calc(100vh - 310px);overflow-y: auto;">
          ...
          <el-table-column align="center" label="反馈标题" header-align="center" prop="title" show-overflow-tooltip />
          ...
          <el-table-column label="软件版本" align="center" show-overflow-tooltip width="120">
            ...
            <el-table-column align="center" show-overflow-tooltip label="反馈类型" width="80">
            <template slot-scope="{row}">
              <el-tag 
